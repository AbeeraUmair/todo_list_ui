    ...
    <div className="flex justify-center items-center h-screen">
      <div className="w-96 bg-white p-6 rounded-lg shadow-md">
        ...
        <form onSubmit={handleSignup}>
          ...
          <input className="p-2 border border-gray-300 rounded-lg mb-2 w-80 flex justify-self-center" autoComplete="username" type="email" name="email" placeholder="Email" value={formData.email} onChange={handleChange} required />
